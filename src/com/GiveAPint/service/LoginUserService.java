...
public interface LoginUserService {
	 ...
	 * existing token with a new token. When the userName does not match with the passcode,
	 * it does not set the token value which can be used as one of the error check.
	 * 
	 * @param user
	 ...
	 * @param token corresponding to the userId.
